...
static const char *const yytname[] =
{
  ...
  "Program", "FunctionDeclaration", "Block", "ReturnStatement", YY_NULLPTR
};
#endif
...
#line 56 "src/c_parser.y" /* yacc.c:1661  */
    { (yyval.node)= new ReturnStat((yyvsp[-2].string),(yyvsp[-1].number)); }
