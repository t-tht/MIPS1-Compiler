...
static const char *const yytname[] =
{
  ...
  "T_SEMICOLON", "T_COMMA", "T_NUMBER", "T_IDENTIFIER", "T_RETURN",
  "T_TYPE", "T_INT", "T_VOID", "T_ADD", "$accept", "ROOT", "Program",
  "FunctionDeclaration", "Block", "ReturnStatement", "Expression", "Term",
  "Factor", "Param", "ParamDec", YY_NULLPTR
};
#endif
...
{
     -13,    -9,    18,   -13,   -14,     2,   -14,   -14,    11,    12,
       5,   -14,    -3,    13,   -14,    15,    -5,     9,   -14,   -14,
      -6,    -3,    -3,   -14,    -3,    -3,   -14,   -14,    -4,   -14,
       9,     9,   -14,   -14,   -14,    14,   -14
};
...
{
       0,     0,     0,     2,     3,     0,     1,     4,     0,     0,
       0,     5,     0,     0,    14,    15,     0,     8,    11,     6,
       0,     0,     0,     7,     0,     0,    16,    20,     0,    18,
       9,    10,    12,    13,    17,     0,    19
};
...
{
      21,    22,    26,     1,    34,     5,    23,    27,    35,     8,
      14,    15,    24,    25,    30,    31,    32,    33,     6,     9,
      12,    10,    20,    19,     7,    36,     0,    27
};

static const yytype_int8 yycheck[] =
{
       5,     6,     8,    16,     8,    14,    11,    13,    12,     7,
      13,    14,     3,     4,    21,    22,    24,    25,     0,     8,
      15,     9,     7,    10,     3,    35,    -1,    13
};
...
{
       0,    16,    21,    22,    23,    14,     0,    23,     7,     8,
       9,    24,    15,    25,    13,    14,    26,    27,    28,    10,
       7,     5,     6,    11,     3,     4,     8,    13,    29,    30,
      27,    27,    28,    28,     8,    12,    30
};
...
#line 74 "src/c_parser.y" /* yacc.c:1646  */
    { (yyval.node) = new ParamDec((yyvsp[0].node), NULL); }
#line 1355 "src/c_parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 19:
#line 75 "src/c_parser.y" /* yacc.c:1646  */
    { (yyval.node) = new ParamDec((yyvsp[-2].node), (yyvsp[0].node)); }
...
#line 187 "src/c_parser.y" /* yacc.c:1906  */
